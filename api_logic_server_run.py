...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 09.01.21, July 27, 2023 17:18:35):
...
app_logger.info(f'Created July 27, 2023 17:18:35 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 09.01.21\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 09.01.21\n'
    if is_docker():
